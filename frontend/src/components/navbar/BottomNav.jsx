...
import MenuBox from './dropdown/MenuBox';

const dropDown = {
  NewFeatures: ['New Release', 'SNKRS launch calender', 'Member Access', 'Air Force 1', 'Basic Essentials', 'Football Club Kits', 'Sustainable Materials', 'Sale'],
  ...
  Shop: [ {ShopBySport:['Running', 'Football', 'Basketball', 'Training', 'Yoga', 'Skateboarding', 'Tennis and Golf']}, { ShopByBrands:['Nike SportsWare', 'Nike Lab', 'Nike By You', 'Jordan', 'ACG', 'NBA', 'Nike SB'] } ],
...
const BottomNav = () => {
  ...
  return (
    <Flex position={'relative'} alignItems={'center'} justifyContent={'space-between'} p={'.5rem 2rem'}>
        ...
        <Flex onMouseOver={(event)=>{handleOnHover(event)}}  position={'absolute'} left='50%' transform={'translateX(-50%)'} fontWeight='600'>
          ...
          <Dropdown cName={hover?'showDropDown':'hideDropDown'} handleOffHover={handleOffHover}  />
          <MenuBox  hover={hover} subMenu = {subMenu}  />
